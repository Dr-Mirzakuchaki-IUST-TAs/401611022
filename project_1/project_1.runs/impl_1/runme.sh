...
HD_PWD='C:/Users/yas_s/OneDrive/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AD4030_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AD4030_FSM.tcl -notrace

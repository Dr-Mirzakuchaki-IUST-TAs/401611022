...
HD_PWD='C:/Users/yas_s/OneDrive/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AD4030_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AD4030_FSM.tcl
